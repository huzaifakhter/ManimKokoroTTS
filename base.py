...
class SpeechService(ABC):
    ...
    def _wrap_generate_from_text(self, text: str, voice: str, path: str = None, **kwargs) -> dict:
        # Replace newlines with lines, reduce multiple consecutive spaces to single
        text = " ".join(text.split())

        dict_ = self.generate_from_text(text, voice, cache_dir=None, path=path, **kwargs)
    ...
    def generate_from_text(
        self, text: str, voice: str, cache_dir: str = None, path: str = None,  **kwargs
    ) -> dict:
