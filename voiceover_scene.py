...
class VoiceoverScene(Scene):
    ...
    def add_voiceover_text(
        ...
        **kwargs,
        ...
        dict_ = self.speech_service._wrap_generate_from_text(text,voice, **kwargs)
    ...
    @contextmanager
    def voiceover(
        self, text: str = None, ssml: str = None, voice: str = 'af_heart',**kwargs
        ...
        try:
            if text is not None:
                yield self.add_voiceover_text(text,voice, **kwargs)
            elif ssml is not None:
                yield self.add_voiceover_ssml(ssml,voice,  **kwargs)
        finally:
